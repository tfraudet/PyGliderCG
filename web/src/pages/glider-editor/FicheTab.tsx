			...
			<Card className="border-border/60 bg-card/80">
				<CardContent className="space-y-8 pt-6">
					...
					<div className="grid gap-4 sm:grid-cols-2">
						...
						<div className="flex flex-col gap-1.5">
							<Label className="text-xs text-muted-foreground">Numero de serie</Label>
							<Input
								type="number"
					...
					<div className="space-y-5">
						<div className="space-y-2">
							...
							<div className="flex flex-col gap-1.5">
								<Label className="text-xs text-muted-foreground">Plan de référence et type d'appui</Label>
								<Select
						...
						<div className="grid gap-4 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:items-start">
							<div className="space-y-4">
								...
								<div className="space-y-2">
									<Label className="text-sm font-medium text-foreground">Position du pilote</Label>
							...
							<div className="grid gap-4">
								<div className="flex flex-col gap-1.5">
									<Label className="text-xs text-muted-foreground">Plan de référence</Label>
									<Input
								...
								<div className="flex flex-col gap-1.5">
									<Label className="text-xs text-muted-foreground">Cale de référence</Label>
									<Input
										value={draft.wedge}
								...
								<div className="flex flex-col gap-1.5">
									<Label className="text-xs text-muted-foreground">Position de la cale de référence</Label>
									<Input
